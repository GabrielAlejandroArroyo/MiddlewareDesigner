...
@Component({
  selector: 'app-module-preview-panel',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  template: `
    <div class="row g-4 module-preview-content" [class.module-preview-compact]="compactMode">
      <!-- Sidebar: Servicios Habilitados -->
      <div [class]="compactMode ? 'col-md-2' : 'col-md-3'">
        ...
        <!-- Main Content -->
        <div [class]="compactMode ? 'col-md-10' : 'col-md-9'">
                  ...
                  <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="mt-auto pt-3 border-top d-flex flex-column gap-2">
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        <button *ngIf="showConfigurarLink" [routerLink]="['/inspect', selectedServiceId, 'action-definition']" 
    ...
    <style>
      ...
      .module-preview-compact .preview-sidebar {
        top: 10px !important;
...
export class ModulePreviewPanelComponent implements OnInit {
  @Input() compactMode = false;
  @Input() showConfigurarLink = true;
  @Output() serviceSelected = new EventEmitter<{ id: string; raw: BackendService } | null>();
  ...
  selectService(id: string) {
    ...
    this.serviceSelected.emit(this.selectedServiceRaw ? { id, raw: this.selectedServiceRaw } : null);
    this.loading = true;
